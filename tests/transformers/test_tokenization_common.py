...
from rating_model.transformers import PreTrainedTokenizer, PreTrainedTokenizerBase, PreTrainedTokenizerFast
from rating_model.transformers.testing_utils import slow
from rating_model.transformers.tokenization_utils import AddedToken
            ...
            with self.subTest(f"{tokenizer.__class__.__name__}"):
                ...
                if tokenizer.pad_token_id is None:
                    ...
                    for key in encoded_sequences.keys():
                        ...
                        self.assertEqual(tensorflow_value, encoded_value)

...
class BatchEncoding(UserDict):
    ...
    Args:
        ...
        tensor_type (:obj:`Union[None, str, TensorType]`, `optional`):
            You can give a tensor_type here to convert the lists of integers in TensorFlow/Numpy Tensors at
            initialization.
    ...
    def convert_to_tensors(
        ...
        if tensor_type == TensorType.TENSORFLOW:
            ...
            raise ImportError(
                "Unable to convert output to tensors format {}, TensorFlow is not available.".format(
                    tensor_type
                )
            )
...
class PreTrainedTokenizerBase(SpecialTokensMixin):
    ...
    @add_end_docstrings(
        ...
        """
        Returns:
            :obj:`List[int]`, :obj:`tf.Tensor` or :obj:`np.ndarray`:
    ...
    def pad(
        ...
        Args:
            encoded_inputs (:class:`~transformers.BatchEncoding`, list of :class:`~transformers.BatchEncoding`, :obj:`Dict[str, List[int]]`, :obj:`Dict[str, List[List[int]]` or :obj:`List[Dict[str, List[int]]]`):
                ...
                you can use this method during preprocessing.
            padding (:obj:`bool`, :obj:`str` or :class:`~transformers.tokenization_utils_base.PaddingStrategy`, `optional`, defaults to :obj:`False`):

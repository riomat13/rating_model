...
from rating_model.transformers import SingleSentenceClassificationProcessor as Processor
from rating_model.transformers import TextClassificationPipeline
from rating_model.transformers.commands import BaseTransformersCLICommand
